...
export const metadata: Metadata = {
  title: "API Access - Agrikul",
  description: "Manage your API access settings",
};
...
export default async function ApiAccessPage() {
  ...
  if (!session) {
    redirect("/auth/login?callbackUrl=/dashboard/settings/api");
  }
    ...
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        <div className="md:col-span-1">
          <SettingsSidebar activePage="api" />
        </div>
        ...
        <div className="md:col-span-3">
          <div className="neuro-card p-6 bg-dark-800 rounded-lg relative overflow-hidden">
            ...
            <div className="relative z-10">
              <h2 className="text-xl font-semibold mb-6 text-white">API Access</h2>
              
              <ApiAccessForm user={session.user} />
            </div>
          </div>
        </div>
      </div>
